...
func invoke[F any, V comparable](e *Env, idx int32, call func(F) V) (ret V) {
...
func (e *Env) Xinvoke_v(v0 int32) {
	invoke(e, v0, func(f func()) int32 { f(); return 0 })
}

func (e *Env) Xinvoke_vi(v0, v1 int32) {
	invoke(e, v0, func(f func(int32)) int32 { f(v1); return 0 })
}

func (e *Env) Xinvoke_vii(v0, v1, v2 int32) {
	invoke(e, v0, func(f func(int32, int32)) int32 { f(v1, v2); return 0 })
}

func (e *Env) Xinvoke_viii(v0, v1, v2, v3 int32) {
	invoke(e, v0, func(f func(int32, int32, int32)) int32 { f(v1, v2, v3); return 0 })
}

func (e *Env) Xinvoke_viiii(v0, v1, v2, v3, v4 int32) {
	invoke(e, v0, func(f func(int32, int32, int32, int32)) int32 { f(v1, v2, v3, v4); return 0 })
}

func (e *Env) Xinvoke_i(v0 int32) int32 {
	return invoke(e, v0, func(f func() int32) int32 { return f() })
}
...
func (e *Env) Xinvoke_ij(v0 int32, v1 int64) int32 {
	return invoke(e, v0, func(f func(int64) int32) int32 { return f(v1) })
}

func (e *Env) Xinvoke_id(v0 int32, v1 float64) int32 {
	return invoke(e, v0, func(f func(float64) int32) int32 { return f(v1) })
}

func (e *Env) Xinvoke_di(v0, v1 int32) float64 {
	return invoke(e, v0, func(f func(int32) float64) float64 { return f(v1) })
}

func (e *Env) Xinvoke_ii(v0, v1 int32) int32 {
	return invoke(e, v0, func(f func(int32) int32) int32 { return f(v1) })
}

func (e *Env) Xinvoke_iii(v0, v1, v2 int32) int32 {
	return invoke(e, v0, func(f func(int32, int32) int32) int32 { return f(v1, v2) })
}

func (e *Env) Xinvoke_iiii(v0, v1, v2, v3 int32) int32 {
	return invoke(e, v0, func(f func(int32, int32, int32) int32) int32 { return f(v1, v2, v3) })
}

func (e *Env) Xinvoke_iiiii(v0, v1, v2, v3, v4 int32) int32 {
	return invoke(e, v0, func(f func(int32, int32, int32, int32) int32) int32 { return f(v1, v2, v3, v4) })
}
